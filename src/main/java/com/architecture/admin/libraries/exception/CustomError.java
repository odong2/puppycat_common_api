...
public enum CustomError {
    ...
    , CONTENTS_WALK_TYPE_ERROR("ECON-3979", "lang.contents.exception.walk.type.error")                            // 산책글이 아닙니다.
    ...
    , CONTENTS_WALK_UUID_EMPTY("ECON-2990", "lang.contents.exception.walk.uuid.empty")                            // 산책 uuid 값이 없습니다.
    ...
    // EPET : 반려동물 관련 오류
    , PET_IDX_ERROR("EPET-9999", "lang.pet.exception.idx.null")         // 존재하지 반려동물 입니다.
    ...
    , PET_PERSONALITY_REGISTER_FAIL("EPET-9995", "lang.pet.personality.etc.register.exception")      // 성격 기타 등록 실패하였습니다.
    , PET_BREED_REGISTER_FAIL("EPET-9994", "lang.pet.breed.etc.register.exception")                  // 품종 기타 등록 실패하였습니다.
    , PET_PROFILE_IMG_REGISTER_FAIL("EPET-9993", "lang.pet.profile.img.register.exception")          // 프로필 이미지 등록 실패하였습니다.
    , PET_PROFILE_IMG_LOG_REGISTER_FAIL("EPET-9992", "lang.pet.profile.img.log.register.exception")  // 프로필 이미지 로그 등록 실패하였습니다.
    , PET_HEALTH_REGISTER_FAIL("EPET-9991", "lang.pet.health.register.exception")      // 건강질환 등록 실패하였습니다.
    , PET_ALLERGY_REGISTER_FAIL("EPET-9990", "lang.pet.allergy.register.exception")    // 알러지 등록 실패하였습니다.
    , PET_UPDATE_FAIL("EPET-9989", "lang.pet.exception.update")                        // 반려동물 수정에 실패하였습니다.
    , PET_BREED_UPDATE_FAIL("EPET-9988", "lang.pet.exception.breed.modify")            // 품종 기타 수정에 실패하였습니다.
    , PET_PERSONALITY_UPDATE_FAIL("EPET-9987", "lang.pet.exception.personality.modify")// 성격 기타 수정에 실패하였습니다.
    , PET_ALLERGY_DELETE_FAIL("EPET-9986", "lang.pet.exception.allergy.delete")        // 알러지 삭제에 실패하였습니다.
    , PET_HEALTH_DELETE_FAIL("EPET-9985", "lang.pet.exception.health.delete")          // 건강 질환 삭제에 실패하였습니다.
    , PET_DELETE_FAIL("EPET-9984", "lang.pet.exception.pet.delete")                    // 펫 삭제에 실패하였습니다.
    , PET_IMAGE_UPDATE_FAIL("EPET-9983", "lang.pet.exception.image.update")            // 펫 프로필 수정에 실패하였습니다.
    , PET_UID_DUPLE("EPET-3999", "lang.pet.exception.uuid.duple")                       // 이미 존재하는 고유아이디입니다.
    , PET_NAME_TEXT_LIMIT_OVER("EPET-3998", "lang.pet.exception.name.text.limit.over")  // 이름은 최소 2자 이상 및 최대 20자까지 입력 가능합니다.
    ...
    , PET_BIRTH_ERROR("EPET-3990", "lang.pet.exception.birth.error")            // 생년월일 값 오류
    , PET_PERSONALITY_IDX_ERROR("EPET-3989", "lang.pet.exception.personality.idx.error")      // 존재하지 않는 성격코드 입니다.
    , PET_PERSONALITY_ETC_NULL("EPET-3988", "lang.pet.exception.personality.etc.null")        // 성격을 입력해주세요.
    , PET_PERSONALITY_TEXT_LIMIT_OVER("EPET-3987", "lang.pet.exception.personality.text.limit.over")      // 성격은 40자 이상 입력 불가합니다.
    , PET_BREED_NAME_TEXT_LIMIT_OVER("EPET-3986", "lang.pet.exception.breed.name.text.limit.over")        // 품종은 12자 이상 입력 불가합니다.
    , PET_NAME_STRING_ERROR("EPET-3985", "lang.pet.exception.name.string")              // 사용할 수 없는 문자가 포함되어 있습니다.
    , PET_BREED_STRING_ERROR("EPET-3984", "lang.pet.exception.breed.string")            // 사용할 수 없는 문자가 포함되어 있습니다.
    , PET_AGE_ERROR("EPET-3983", "lang.pet.exception.age.error")                        // 연령 값 오류
    , PET_NOT_MY_PET("EPET-3982", "lang.pet.exception.not.my.pet.error")                // 나의 반려동물만 열람 가능합니다.
    , PET_NOT_MEMBER_OWN_PET("EPET-3981", "lang.pet.exception.not.member.own")          // 회원 소유의 반려동물이 아닙니다.
    , PET_UUID_ERROR("EPET-3980", "lang.pet.exception.uuid.error")                      // 존재하지 않는 반려동물입니다.
    , PET_BIRTH_STRING_ERROR("EPET-3979", "lang.pet.exception.birth.string.error")      // 생년월일 형식 에러
    , PET_NAME_NULL("EPET-2999", "lang.pet.exception.name.null")                        // 이름을 입력해주세요.
    , PET_BREED_NAME_NULL("EPET-2998", "lang.pet.exception.breed.etc.name.null")        // 품종을 입력해주세요.
    , PET_BREED_IDX_NULL("EPET-2997", "lang.pet.exception.breed.idx.null")              // 품종을 선택해주세요.
    , PET_GENDER_NULL("EPET-2996", "lang.pet.exception.gender.null")    // 성별을 선택해주세요.
    , PET_SIZE_NULL("EPET-2995", "lang.pet.exception.size.null")        // 사이즈를 선택해주세요.
    , PET_WEIGHT_NULL("EPET-2994", "lang.pet.exception.weight.null")    // 몸무게를 입력해주세요.
    , PET_BIRTH_NULL("EPET-2993", "lang.pet.exception.birth.null")      // 생년월일을 입력해주세요.
    , PET_AGE_NULL("EPET-2992", "lang.pet.exception.age.null")          // 연령을 선택해주세요.
    ...
    // EWAL : 산책 관련 오류
    , WALK_UUID_ERROR("EWAL-3999", "lang.common.walk.exception.uuid") // 존재하지 않는 산책 아이디입니다.
